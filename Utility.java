...
public class Utility {
    ...
    public static IndexPageId getIndexPageId(int tbid, int pgnu){	//@Pouria
    	return new IndexPageId(tbid, pgnu, -1);
    }
    
    public static AccessPredicate getIntAccessPredicate(Predicate.Op o, int i){	//@Pouria
    	return new AccessPredicate(o, new IntField(i));
    }
    
    public static AccessPredicate getStringAccessPredicate(Predicate.Op o, String s){	//@Pouria
    	return new AccessPredicate(o, new StringField(s, s.length()));
    }
}
